...
import { getComponentPage, getAddComponentPage, postNewComponent, getComponentDetailsPage, deleteComponent, getEditComponent, editNewComponent} from "../controller/componentsController.js";
...
componentsRouter.post("/components/:component_id/edit", upload.single('component_image'), editNewComponent); 
